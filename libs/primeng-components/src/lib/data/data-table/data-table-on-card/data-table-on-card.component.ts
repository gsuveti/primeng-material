...
@Component({
  selector: 'primeng-material-data-table-on-card',
  templateUrl: './data-table-on-card.component.html',
  styleUrls: ['./data-table-on-card.component.scss']
})
export class DataTableOnCardComponent implements OnInit {
  sales: any[];
